 ...
 *
 *
 * This file has been modified by QutiPi-CPP to work with the framework and reduce size.
 *      - Depreciated functions have been removed
 *      - Use of pragma once
 *      - Correct namespacing
 *      - MBED_ASSERT replaced with assert
 */
#pragma once
...
namespace QutiPi { namespace Platform
{
    ...
    private:
        ...
        void generate(const F &f) {
            ...
            assert(sizeof(Callback) - sizeof(_ops) >= sizeof(F));
            new (this) F(f);
            _ops = &ops;
        }
